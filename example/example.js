const FlareExample = (function (anim)
{
	...
	*/
	...
	FlareExample.prototype.setActor = function(actor)
	{
		...
		if(actorInstance)
		{
			...
			if(actorInstance._Animations.length)
			{
				...
				this._Animation = actorInstance._Animations[3];
	...
	FlareExample.prototype.setAnimation2 =function (animation){
	 	 console.log('hi from js',animation);
		...
		//this.setAnimation([3]);
		console.log(this._ActorInstance.animations);
		

		this._AnimationInstance = new Flare.AnimationInstance(this._Animation._Actor, this._ActorInstance.animations[animation]);
